...
class SemAtrasoAppFinanceiroSupabaseUser extends BaseAuthUser {
  SemAtrasoAppFinanceiroSupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> semAtrasoAppFinanceiroSupabaseUserStream() {
  ...
  return (!loggedIn
    ...
    (authState) {
      currentUser =
          SemAtrasoAppFinanceiroSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
